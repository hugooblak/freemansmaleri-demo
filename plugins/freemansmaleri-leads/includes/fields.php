...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'freemansmaleri-leads' ),
				'storm'       => __( 'Storm or hail damage', 'freemansmaleri-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'freemansmaleri-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'freemansmaleri-leads' ),
				'not-sure'    => __( 'Vet inte än', 'freemansmaleri-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'freemansmaleri-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'freemansmaleri-leads' ),
				'research' => __( 'Jag kollar bara priser', 'freemansmaleri-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'freemansmaleri-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'freemansmaleri-leads' ),
		'contacted' => __( 'Kontaktad', 'freemansmaleri-leads' ),
		'quoted'    => __( 'Quote sent', 'freemansmaleri-leads' ),
		'won'       => __( 'Won', 'freemansmaleri-leads' ),
		'lost'      => __( 'Lost', 'freemansmaleri-leads' ),
		'spam'      => __( 'Misstänkt spam', 'freemansmaleri-leads' ),
	);
}
