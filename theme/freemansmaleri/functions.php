<?php
/**
 * Freemans Måleri AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Freemans Måleri AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'freemansmaleri', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'freemansmaleri' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'freemansmaleri' ) ) );

		register_block_pattern_category( 'freemansmaleri-sections', array( 'label' => __( 'Freemans Måleri AB sections', 'freemansmaleri' ) ) );
		register_block_pattern_category( 'freemansmaleri-pages', array( 'label' => __( 'Freemans Måleri AB page layouts', 'freemansmaleri' ) ) );
	}
);
